...
<img src="T:\iMonitor\Public\doc\sysmon.gif" />
...
> 免责说明：
>
> iMonitorSDK（以下称本SDK）只授权给为正规的企业厂商使用。禁止用于危害国家、企业、个人安全等任何非法的场景。
>
> 本SDK带有内核驱动程序，虽然已经经过稳定测试，长期运行验证，但因为硬件、环境等原因，不可避免会存在兼容性问题，可能会导致蓝屏、死机、数据丢失等。在使用本SDK前，请先在业务对应的环境系统中充分测试后再实际接入使用。
>
